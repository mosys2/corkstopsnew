...
namespace Store.Persistence.Migrations
{
    ...
    [Migration("20230511114421_Insert_ContactTypes3")]
    partial class Insert_ContactTypes3
    {
            ...
            modelBuilder.Entity("Store.Domain.Entities.Contacts.ContactType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Icon = "smartphone",
                            InsertTime = new DateTime(2023, 5, 11, 16, 14, 20, 999, DateTimeKind.Local).AddTicks(8617),
                            IsRemoved = false,
                            Title = "Mobile",
                            Value = "Mobile"
                        },
                        new
                        {
                            Id = 2L,
                            Icon = "phone",
                            InsertTime = new DateTime(2023, 5, 11, 16, 14, 20, 999, DateTimeKind.Local).AddTicks(8634),
                            IsRemoved = false,
                            Title = "Phone",
                            Value = "Phone"
                        },
                        new
                        {
                            Id = 3L,
                            Icon = "mail",
                            InsertTime = new DateTime(2023, 5, 11, 16, 14, 20, 999, DateTimeKind.Local).AddTicks(8647),
                            IsRemoved = false,
                            Title = "Email",
                            Value = "Email"
                        },
                        new
                        {
                            Id = 4L,
                            Icon = "map-pin",
                            InsertTime = new DateTime(2023, 5, 11, 16, 14, 20, 999, DateTimeKind.Local).AddTicks(8660),
                            IsRemoved = false,
                            Title = "Address",
                            Value = "Address"
                        },
                        new
                        {
                            Id = 5L,
                            Icon = "home",
                            InsertTime = new DateTime(2023, 5, 11, 16, 14, 20, 999, DateTimeKind.Local).AddTicks(8671),
                            IsRemoved = false,
                            Title = "PostalCode",
                            Value = "PostalCode"
                        });
            ...
            modelBuilder.Entity("Store.Domain.Entities.Users.Roll", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2023, 5, 11, 16, 14, 20, 999, DateTimeKind.Local).AddTicks(8525),
                            IsRemoved = false,
                            RollName = "Admin",
                            Title = "Admin"
                        },
                        ...
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2023, 5, 11, 16, 14, 20, 999, DateTimeKind.Local).AddTicks(8595),
                            IsRemoved = false,
                            RollName = "Customer",
                            Title = "Customer"
                        });
